    ...
    <div id="layoutSidenav_content">
        <main>
            ...
            <div class="container mt-3">
                <div class="row">
                    <div class="col-12 col-md-4 mb-3">
                        <label for="exampleFormControlInput1" class="form-label">Filtrar por estado</label>
                        <select class="form-select" aria-label="Default select example" id="estadeSelect">
                    ...
                    <div class="col-12 col-md-4 mb-3">
                        <div class="mb-3">
                            <label for="exampleFormControlInput1" class="form-label">Filtrar por fecha</label>
                            <input type="date" class="form-control" id="filterDate" placeholder="name@example.com">
                        </div>
                    </div>
                    <div class="col-12 col-md-4 text-end">
                        <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#newOrderPurchase">
                            Nueva movimiento<i class="fa-solid fa-plus ps-2"></i>
                        </button>
                    </div>
                </div>
            </div>
            ...
            <div class="container mt-5">
                <div class="row">
                    <div class="col-12" id="listOrderPurchase">
                        <!-- Contenido de la lista de ordenes -->
                    </div>
                </div>
            </div>
        </main>
...
<div class="modal fade" id="newOrderPurchase" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel">Nueva orden de compra</h1>
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <hr>
                    <div class="col-12">
                        <table class="table" id="productSupplier">
                            <thead>
                            <tr>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-success" id="createOrder" disabled>Crear Orden</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="viewpdf" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel">Ver pdf</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cerrar</button>
                <a id="downloadPDF" class="btn btn-success" download="orden.pdf">Descargar PDF</a>
...
<div class="modal fade" id="viewOrderPurchase" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel">Ver orden de compra</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-6">
                        <div class="mb-3">
                            <label for="disabledSelect" class="form-label">Proveedor</label>
                            <select id="proveedorSelectView" class="form-select" disabled>
                                <option>Disabled select</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="mb-3">
                            <label for="exampleFormControlInput1" class="form-label">Fecha de creacion</label>
                            <input type="date" class="form-control" id="dateOrderView" disabled>
                        </div>
                    </div>
                    <hr>
                    <div class="col-12">
                        <table class="table" id="productSupplierView">
                            <thead>
                            <tr>
                                <th scope="col">Imagen</th>
...
<script src="./Vista/js/OrderPurchase/main.js"></script>
</body>
</html>
